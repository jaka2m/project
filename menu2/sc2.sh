...
lane_atas
echo -e "${c}│      ${g}PROCESS INSTAKKED MODUL DDoS-Deflate${NC}     ${c}│${NC}"
lane_bawah
...
echo -e "${c}│      ${g}PROCESS INSTAKKED DIRECTORY XRAY${NC}     ${c}│${NC}"
lane_bawah
mkdir -p /etc/xray
...
echo -e "${c}│      ${g}PROCESS INSTAKKED UBUNTU $(cat /etc/os-release | grep -w PRETTY_NAME | head -n1 | sed 's/=//g' | sed 's/"//g' | sed 's/PRETTY_NAME//g')${NC}     ${c}│${NC}"
lane_bawah
...
echo -e "${c}│      ${g}PROCESS INSTAKKED DEBIAN $(cat /etc/os-release | grep -w PRETTY_NAME | head -n1 | sed 's/=//g' | sed 's/"//g' | sed 's/PRETTY_NAME//g')${NC}     ${c}│${NC}"
lane_bawah
apt-get -y install --no-install-recommends software-properties-common > /dev/null 2>&1
...
#print_install "MEMASANG PASSWORD SSH"
    lane_atas
    echo -e "${c}│      ${g}PROCESS INSTALLED SSH${NC}     ${c}│${NC}"
    lane_bawah
...
#print_install "MENGINSTALL DROPBEAR"
    lane_atas
    echo -e "${c}│      ${g}PROCESS INSTALLED DROPBEAR${NC}     ${c}│${NC}"
    lane_bawah
...
#print_install "MEMASANG UDP MINI"
    lane_atas
    echo -e "${c}│      ${g}PROCESS INSTALLED UDP MINI${NC}     ${c}│${NC}"
    lane_bawah
...
#print_install "MEMASANG SSH UDP"
    lane_atas
    echo -e "${c}│      ${g}PROCESS INSTALLED SSH UDP${NC}     ${c}│${NC}"
    lane_bawah
mkdir -p /etc/geovpn/
...
#print_install "Memulai Instalasi VNSTAT"
    lane_atas
    echo -e "${c}│      ${g}PROCESS INSTALLED VNSTAT${NC}     ${c}│${NC}"
    lane_bawah
...
#print_install "MENGINSTALL OPENVPN"
    lane_atas
    echo -e "${c}│      ${g}PROCESS INSTALLED OPENVPN${NC}     ${c}│${NC}"
    lane_bawah
...
#print_install "MEMASANG LIMIT XRAY"
    lane_atas
    echo -e "${c}│      ${g}PROCESS INSTALLED LIMIT XRAY${NC}     ${c}│${NC}"
    lane_bawah
...
#print_install "MENGINSTALL EPRO WEBSOCKET PROXY"
    lane_atas
    echo -e "${c}│      ${g}PROCESS INSTALLED EPRO WEBSOCKET PROXY${NC}     ${c}│${NC}"
    lane_bawah
...
#print_install "RESTARTING  ALL PACKAGES"
    lane_atas
    echo -e "${c}│      ${g}PROCESS RESTARTING  ALL PACKAGES${NC}     ${c}│${NC}"
    lane_bawah
